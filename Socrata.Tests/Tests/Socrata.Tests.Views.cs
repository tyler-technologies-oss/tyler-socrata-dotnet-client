...
namespace Socrata
{
    ...
    public class ViewTests
    {
        ...
        public void ViewSchemaMatches()
        {
            ...
            SODASchema viewSchema = new SchemaBuilder().AddColumn(new Column("text", SocrataDataType.TEXT)).Build();
            Assert.AreEqual(newView.schema.ToString(), viewSchema.ToString());
            // Clean it up
            newView.Delete();
            newDataset.Delete();
        }
